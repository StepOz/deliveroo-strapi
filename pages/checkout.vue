        ...
        <div class="col-md-6 offset-md-3 mt-3">
          <form autocomplete="off" @submit.stop.prevent="handleSubmit">
            ...
            <div class="form-group">
              ...
              <card
                class="form-control"
                stripe="pk_test_OTe5a0NdCqw2kl8szZE1BuQR"
              />
            </div>
...
const apiUrl = process.env.API_URL || 'http://localhost:3107'
  ...
  methods: {
    async handleSubmit() {
      ...
      try {
        ...
        alert('An error occurred when generate token.')
        this.loading = false
        return
      }
      try {
        ...
        this.loading = false
        alert('An error occurred when pass the order.')
      }
    },
    ...mapMutations({
      addToCard: 'card/add',
